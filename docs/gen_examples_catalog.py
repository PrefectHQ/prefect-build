...
import prefect_build

COLLECTION_SLUG = "prefect_build"
...
for module_name, module_obj in getmembers(prefect_build, ismodule):
...
with mkdocs_gen_files.open(examples_catalog_path, "w") as generated_file:
    generated_file.write(
        dedent(
            ...
            Below is a list of examples for `prefect-build`.
            """
        )
    )
