...
class BuildBlock(Block):
    ...
    Example:
        Load a stored value:
        ```python
        from prefect_build import BuildBlock
        block = BuildBlock.load("BLOCK_NAME")
        ```
    """

    _block_type_name = "build"
    ...
    _documentation_url = "https://prefecthq.github.io/prefect-build/blocks/#prefect-build.blocks.BuildBlock"  # noqa
